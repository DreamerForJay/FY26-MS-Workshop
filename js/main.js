(() => {
  ...
  const translations = {
    zh: {
      ...
      intro:"資工學生，也是研發實習生。正在累積 AI、軟體測試與產品實作的經驗。",
      ...
      aboutBody:"我習慣先釐清需求、動手驗證，再從回饋調整。工作之外，我喜歡拉麵、旅行、馬拉松、登山與各種運動，也樂於接觸新科技、太空知識，主動走出舒適圈。",
    ...
    en: {
      ...
      intro:"Computer Science student and R&D intern, learning through AI, software testing, and hands-on product work.",
      ...
      aboutBody:"I clarify requirements, test ideas, and improve through feedback. Outside work, I enjoy ramen, travel, marathons, hiking, sports, new technology, and space—especially challenges that take me beyond my comfort zone.",
